#
# Be sure to run `pod lib lint M2DSegmentedControl.podspec' to ensure this is a
...
Yeah.
  ...
  s.source_files = 'M2DSegmentedControl/Classes/**/*'
  
  # s.resource_bundles = {
  #   'M2DSegmentedControl' => ['M2DSegmentedControl/Assets/*.png']
  # }
